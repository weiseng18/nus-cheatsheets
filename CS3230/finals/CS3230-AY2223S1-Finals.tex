...
\section*{NP-Completeness}
  ...
  \subsection*{Problem definitions}
    ...
    \subsubsection*{Vertex-Cover} \noindent
      ...
      \begin{center}
        \includegraphics[width=\columnwidth]{L12/vertex_cover}
      \end{center}
    \subsubsection*{Set-Cover} \noindent
      ...
      \begin{center}
        \includegraphics[width=\columnwidth]{L12/set_cover}
      \end{center}
    \subsubsection*{3-SAT} \noindent
      \begin{itemize}[leftmargin=*]
    ...
    \subsubsection*{Dir-Ham-Cycle} \noindent
      ...
      \begin{center}
        \includegraphics[width=\columnwidth]{L12/dir_ham_cycle}
      \end{center}
...
\section*{Complexity classes}
  ...
  \subsection*{NP}
    \begin{itemize}[leftmargin=*]
      ...
      \item Defined as the class of problems for which polynomial time verifiable certificates of YES-instances exist
      ...
      \item P $\subseteq$ NP because
        \begin{itemize}[leftmargin=*]
          \item Certificate can be anything
          \item Verifier $V(x, \cdot)$ can solve for the instance $x$ by itself and check if it is a YES-instance
        \end{itemize}
    \end{itemize}
  ...
  \subsection*{Relationships}
    ...
    \subsubsection*{Likely relationships}
      \begin{center}
        \includegraphics[width=\columnwidth]{L12/likely_relationships}
      \end{center}
\section*{Approximation}
  \subsection*{Minimization} \noindent
    ...
    \begin{itemize}[leftmargin=*]
      ...
      \item $\dfrac{C}{C^*}$ - approximation ratio, always larger than 1
    \end{itemize}
