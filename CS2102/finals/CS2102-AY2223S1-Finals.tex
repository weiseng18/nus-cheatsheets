...
\section*{Functional Dependencies}
  ...
  \subsection*{FD terminology}
    ...
    \paragraph{Equivalence} Two FDs are equivalent $\iff$ they have the same closure
  ...
  \subsection*{Armstrong axioms}
    ...
    \subsubsection*{Remarks}
      \begin{itemize}[leftmargin=*]
        \item The three inference rules are sound (i.e. correct and valid)
        \item The Armstrong axioms are complete
      \end{itemize}
    ...
    \subsubsection*{Check if decomposed set of relations is in BCNF}
      \begin{enumerate}[leftmargin=*]
        ...
        \item For some pair $(R_i, R_j), i \neq j$,
          ...
          \end{itemize}
        \item If there was a sequence of unions that respected the BCNF definitions, resulting in a single relation that has all attributes, then TRUE. Else FALSE
      \end{enumerate}
